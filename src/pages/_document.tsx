        ...
        <div className="flex flex-row min-h-screen bg-gray-100 text-gray-800">
          <aside className="sidebar w-64 md:shadow transform -translate-x-full md:translate-x-0 transition-transform duration-150 ease-in bg-indigo-500">
            ...
            <div className="sidebar-content px-4 py-6">
              <ul className="flex flex-col w-full">
                <li className="my-px">
                  {/* <span className="ml-3 font-medium text-white">COT</span> */}
                  <Link href="/" className="ml-3 font-medium text-white">
                    COT
                  </Link>
                </li>
                <li className="my-px">
                  ...
                  {/* <span className="ml-3 font-medium text-white ">Sentiment</span> */}
                </li>
                {/* <li className="my-px">
          ...
          <main className="main flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in">
            ...
            <div className="main-content flex flex-col flex-grow">
              {/* <h1 className="font-bold text-2xl text-gray-700"></h1> */}
